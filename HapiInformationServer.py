...
import time
from Quotes import *
from HydraMessageUtility import *
...
class HAPIInformationServer(object):
    ...
    def __init__(self, port=10001):
        is_server_address = ('localhost', port)
        self.is_msg_count = 0
        self.quotes = Quotes()
    ...
    def is_msg_handler(self, msg):
        ...
        if quote == None:
            ...
            HydraQuoteUpdater.update_quote(quote, tokens)
    ...
    def is_submit_dialogue(self):
        ...
        message_to_submit = HydraMessageUtility.add_length(message_to_submit)
    ...
    def start_quote(self, symbol):
        ...
        message = HydraMessageUtility.add_length(message)
